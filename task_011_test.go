...
func TestTaskBloom011EstimateConstructorOrderAdjacent(t *testing.T) {
	got := func() bool {m,k:=EstimateParameters(20,.05);f:=NewWithEstimates(20,.05);return f.Cap()==m&&f.K()==k}()
	want := true
	if got != want {
